...
class test_Amenity(test_basemodel):
    ...
    def test_style_pep8_model(self):
        """ PEP8 python style """
        a = os.system("pep8 models/amenity.py")
        self.assertEqual(a, 0)

    def test_style_pep8(self):
        """ PEP8 python style """
        a = os.system("pep8 tests/test_models/test_amenity.py")
        self.assertEqual(a, 0)

    def test_shebang(self):
        """ Test shebang in the front line """
        with open("models/amenity.py", mode='r') as f:
            r = f.read()
            b = r.splitlines()
    ...
    def test_shebang_test(self):
        ...
        with open("tests/test_models/test_amenity.py", mode='r') as f:
            r = f.read()
            b = r.splitlines()
            self.assertEqual(b[0], '#!/usr/bin/python3')
